...
$use_smtp = '0';
$emailto = 'ventas@persianasdeco.mx';

	// retrieve from parameters
	$emailfrom = isset($_POST["email"]) ? $_POST["email"] : "";
	$nocomment = isset($_POST["nocomment"]) ? $_POST["nocomment"] : "";
	$subject = 'Correo de sitio de internet Persianas Deco';
	$message = '';
	$response = '';
	$response_fail = 'Ocurrio un error, revisa tus datos.';
...
function sendEmail($subject, $content, $emailto, $emailfrom) {
	...
	$from = $emailfrom;
	$response_sent = 'Gracias. Tu mensaje fue recibido.';
	$response_error = 'Error. Por favor intenta de nuevo.';
